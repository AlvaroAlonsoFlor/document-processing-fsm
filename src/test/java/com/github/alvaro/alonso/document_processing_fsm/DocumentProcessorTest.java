...
import com.github.alvaro.alonso.document_processing_fsm.document.submit.SubmitEvent;
...
public class DocumentProcessorTest {
    ...
    void shouldErrorWhenProvidedEventNotValid() {
        Document document = new Document("test", "title", "some content", "Test McTest", DocumentState.DRAFT, null);
        assertThrows(IllegalStateException.class, () -> documentProcessor.processEvent(document, new AssignReviewerEvent(), "Test McTest"));
    }
}
